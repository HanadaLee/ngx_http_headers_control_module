...
typedef struct {
    ...
    ngx_flag_t                         is_input;
} ngx_http_headers_control_cmd_t;


typedef struct {
    ngx_array_t             *cmds; /* of ngx_http_headers_control_cmd_t */
...
typedef struct ngx_http_headers_control_header_val_s
...
struct ngx_http_headers_control_header_val_s {
